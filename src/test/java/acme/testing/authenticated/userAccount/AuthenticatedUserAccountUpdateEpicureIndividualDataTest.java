...
public class AuthenticatedUserAccountUpdateEpicureIndividualDataTest extends TestHarness{

	@ParameterizedTest
	@CsvFileSource(resources = "/authenticated/user-account/updateUserAccountEpicureIndividualData.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)	
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/authenticated/user-account/updateUserAccountEpicureIndividualDataNegative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)	
